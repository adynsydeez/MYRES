...
bvec19 = [0 50 350 800 1500 2400 3450 4750 6000];
...
for l= 73 % select one axial slice
    for x = 1:X
        parfor y = 1:Y
            ...
            [D_MONO(x,y,l), error_MONO(x,y,l)] = fit_voxel_mono([Svec(1:5); Svec(10:11)], [bvec(1:5); bvec(10:11)], Dmin, Dmax);
            [D_DKI(x,y,l), K_DKI(x,y,l), error_DKI(x,y,l)] = fit_voxel_dki([Svec(1:6); Svec(10:12)], [bvec(1:6); bvec(10:12)], D_guess, K_guess, Dmin, Dmax, Kmin, Kmax);
            [D_SUB(x,y,l), BETA_SUB(x,y,l), error_SUB(x,y,l)] = fit_voxel_sub_ml(Svec, bvec, D_guess, beta_guess, Dmin, Dmax, betamin, betamax);

function [D, K, err] = fit_voxel_dki(Svec, bvec19, D_guess, K_guess, Dmin, Dmax, Kmin, Kmax)
    if Svec(1) <= 0
    ...
    [p, resnorm] = lsqcurvefit(model, [D_guess, K_guess], bvec19, Svec, [Dmin, Kmin], [Dmax, Kmax], options);
